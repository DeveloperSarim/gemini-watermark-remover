...
test('Gemini video regression manifest should pin the 20260615 inset samples', async () => {
    ...
    for (const item of manifest.inputs) {
        assert.match(item.input, /^src\/assets\/video-samples\/(?:20260615|veo-20260615)/);
